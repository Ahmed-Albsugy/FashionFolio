...
export class ProductListingComponent {
  ...
  products = [
    {
      ...
      category: "Men", subcategory:"Clothing" , supsupcategory:"Men Suits",
...

    {
      ...
      category: "kids", subcategory:"Clothing" , supsupcategory:"kids Suits",

      image:
        "https://m.media-amazon.com/images/I/71V-TH85HSL._AC_SX522_.jpg",
      rating: {
        rate: 4.7,
        count: 850,
      }
...

    {
      ...
      category: "Women", subcategory:"Clothing" , supsupcategory:"jackets",
      image:
...

    {
      ...
      category: "kids", subcategory:"Clothing" , supsupcategory:"kids Blazers",
...

    {
      ...
      category: "Women", subcategory:"Clothing" , supsupcategory:"Coats",
...

    {
      ...
      category: "Men", subcategory:"Clothing" , supsupcategory:"Men Blazers",
...

    {
      ...
      category: "Women", subcategory:"Clothing" , supsupcategory:"Skirts",
...

    {
      ...
      description:
        ...
        // category: "womens > clothing > Dresses",
      category: "Women", subcategory:"Clothing" , supsupcategory:"Dresses",
...

    {
      ...
      category: "Women", subcategory:"Clothing" , supsupcategory:"Shirts & Blouses",
      image:
...

    {
      ...
      category: "kids", subcategory:"Clothing" , supsupcategory:"kids Shirts",
...

    {
      ...
      category: "Men", subcategory:"Clothing" , supsupcategory:"Men Shirts",
      image:
...

    {
      ...
      category: "Women", subcategory:"Clothing" , supsupcategory:"Clutch Bags",
...

    {
      ...
      category: "Men", subcategory:"Clothing" , supsupcategory:"Men Pants",
...

    {
      ...
      category: "Women", subcategory:"Clothing" , supsupcategory:"Tops",
...

    {
      ...
      category: "kids", subcategory:"Clothing" , supsupcategory:"kids Pants",
...

    {
      ...
      category: "Men", subcategory:"Clothing" , supsupcategory:"Men shorts & Swimwear",
...

    {
      ...
      category: "Men", subcategory:"Clothing" , supsupcategory:"Men Sweaters & Hoodies",
...

    {
      ...
      category: "Women", subcategory:"Clothing" , supsupcategory:"jeans",
      image:
        'https://images-na.ssl-images-amazon.com/images/I/81LlRQoAKyL._SL250_.jpg',
      rating: {
        rate: 3.8,
...

    {
      ...
      category: "Women", subcategory:"Bags" , supsupcategory:"Shoulder Bags",
        image:
        'https://m.media-amazon.com/images/I/61UDx9jF0mL._AC_SL1315_.jpg',
      rating: {
        rate: 3.8,
        count: 679,
      },
...

    {
      ...
      description:
        ...
        image:
        'https://m.media-amazon.com/images/I/71Z2rgjGGPS._AC_UL1500_.jpg',
      rating: {
        rate: 3.8,
        count: 679,
      },
...

    {
      ...
      category: "Women", subcategory:"Bags" , supsupcategory:"STote Bags",
...

    {
      ...
      // category: "womens > Bags > Tote Bags",
      category: "Women", subcategory:"Bags" , supsupcategory:"Tote Bags",

      image:
        "https://m.media-amazon.com/images/I/61501FzWidL._AC_SL1001_.jpg",
      rating: {
        rate: 4.5,
        count: 412,
      }
...

    {
      ...
      // category: "womens > Bags > Clutch Bags",
      category: "Women", subcategory:"Bags" , supsupcategory:"Clutch Bags",
...

    {
      ...
      category: "Women", subcategory:"Bags" , supsupcategory:"BackPacks Bags",
...

    {
      ...
      category: "Women", subcategory:"Bags" , supsupcategory:"Belt Bags",
...

    {
      ...
      category: "Men", subcategory:"Shoes" , supsupcategory:"Adidas",
...

    {
      ...
      category: "Men", subcategory:"Shoes" , supsupcategory:"Nike",
...

    {
      ...
      category: "Men", subcategory:"Shoes" , supsupcategory:"New Balance",
...

    {
      ...
      category: "Men", subcategory:"Shoes" , supsupcategory:"Vanss",
...

    {
      ...
      category: "kids", subcategory:"Clothing" , supsupcategory:"kids Shorts & Swimwear",
...

    {
      ...
      category: "kids", subcategory:"Clothing" , supsupcategory:"kids Sweaters & Hoodies",
      image:
  ...
  onCategorySelected(event: { category: string, subcategory?: string, supsupcategory?: string }) {
    ...
    this.filteredProducts = this.products.filter(product => {
      ...
      const matchesSubCategory = subcategory ? product.subcategory?.toLowerCase() === subcategory.toLowerCase() : true;
      const matchesSupSubCategory = supsupcategory ? product.supsupcategory?.toLowerCase() === supsupcategory.toLowerCase() : true;
